...
<CFQUERY NAME="animals_listing" DATASOURCE="alibaba">
  ...
  <br>
      ...
      <!--- CF Etkileşim Bitişi --->
          ...
          <cfoutput query="animals_listing">
          <p>#sira# #name# #genus# #kind#</p>
          </cfoutput>
          <cfsearch
          collection="#form.Animal#"
          name="animals_listing"
          criteria="#Form.name#"
          maxrows = "100">
          <!--- Output the filename contained in the record set. --->
          <cfoutput>
          Your search returned #animals_listing.name# file(s).
          </cfoutput>
          <cfoutput query="animals_listing">
          <p><table>
          <tr><td>Title: </td><td>#sira#</td></tr>
          <tr><td>Score: </td><td>#genus#</td></tr>
          <tr><td>Key: </td><td>#kind#</td></tr>
